CLASS zjmcr_cl_fill_zs4d401_flights DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZJMCR_CL_FILL_ZS4D401_FLIGHTS IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA flights TYPE TABLE OF /dmo/flight.
    DATA insert_tab TYPE TABLE OF zjmcr_flights.


    DELETE FROM zjmcr_flights.
...
*Add 50 new connection numbers and 2000 days of flights for each
    ...
    INSERT zjmcr_flights FROM TABLE @insert_tab.
    out->write( |Generated { sy-dbcnt } rows in table zjmcr_flights| ).
